          ...
          <div className="flex items-start justify-between">
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="px-3 py-1 bg-yellow-500 text-gray-700 text-sm rounded-md">
                  {pg.genderLabel}
                </span>
              </div>
        ...
        <div className="grid lg:grid-cols-[1fr,400px] gap-6">
          ...
          <div className="bg-teal-50 rounded-2xl p-6 border-2 border-teal-200">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-black border border-yellow-100 rounded-xl p-4 text-center text-teal-700 text-sm">
              ...
              <button className="w-full bg-teal-500 text-white font-bold text-lg py-4 rounded-xl shadow-md hover:bg-teal-600 transition">
                Schedule a Visit
              </button>
            </div>
          </div>
          ...
          <div className="flex">
            {(["occupancy", "amenities", "details"] as const).map((tab) => (
              <button
                ...
                className={`flex-1 py-4 text-lg font-semibold relative transition-colors ${
        ...
        >
          <div className="space-y-12">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                {pg.servicesLabels && pg.servicesLabels.length > 0 ? (
                  pg.servicesLabels.map((item) => (
                    <span
                      key={item}
                      className="px-5 py-2.5 bg-white rounded-full border border-gray-300 text-sm font-medium text-gray-700 flex items-center gap-2"
                    >
